...
//             try {
//                 // const currentVideoId = props.videoId || ("84e96018-4022-434e-80bf-000ce4cd12b8" && const filteredNextVideo = nextVideo.filter(nextVideo => nextVideo.id === "84e96018-4022-434e-80bf-000ce4cd12b8"));
